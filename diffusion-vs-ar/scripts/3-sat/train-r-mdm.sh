...
#SBATCH --output=slurm_output/train_sat_r.out
#SBATCH --error=slurm_output/train_sat_r.err
#SBATCH --nodes=1
#SBATCH --gres=gpu:2
...
exp=/nfs/turbo/coe-jjparkcv-medium/satyam/sr/sat/refine
eval=/home/sagoyal/research/diffusion-vs-ar/eval_results/sat/refine
