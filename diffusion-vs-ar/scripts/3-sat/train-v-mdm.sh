#!/bin/bash
#SBATCH --job-name=train_sat_v
#SBATCH --output=slurm_output/train_sat_v.out
#SBATCH --error=slurm_output/train_sat_v.err
#SBATCH --nodes=1
#SBATCH --gres=gpu:2
...
exp=/nfs/turbo/coe-jjparkcv-medium/satyam/sr/sat/vanilla
eval=/home/sagoyal/research/diffusion-vs-ar/eval_results/sat/vanilla
