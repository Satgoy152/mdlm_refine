...
exp=nfs/turbo/coe-jjparkcv-medium/satyam/sr/sudoku/mdm-alpha0.25-gamma1-bs1024-lr1e-3-ep300-T20
eval=/home/sagoyal/research/diffusion-vs-ar/eval_results/sudoku
mkdir -p $exp
mkdir -p $eval
