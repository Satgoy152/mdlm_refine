#!/bin/bash
#SBATCH --job-name=train_qm89_guidance_mdlm_refine
#SBATCH --output=slurm_output/train_qm89_guidance_mdlm_refine.out
#SBATCH --error=slurm_output/train_qm89_guidance_mdlm_refine.err
#SBATCH --nodes=1
#SBATCH --gres=gpu:2
...
# Submit with: sbatch --export=ALL,PROP=<qed|ring_count> train_qm9_guidance_mdlm_refine.sh
